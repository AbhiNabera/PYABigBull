...
public class UserStocks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(nabera.ranjan.abhinabera.pyabigbull.R.layout.activity_user_stocks);
        getSupportActionBar().hide();

        userStocksToolbar = (android.support.v7.widget.Toolbar) findViewById(nabera.ranjan.abhinabera.pyabigbull.R.id.userStocksToolbar);
        Intent i = getIntent();
        userStocksToolbar.setTitle(i.getExtras().getString("name"));

        userStocksToolbar.setNavigationIcon(getResources().getDrawable(nabera.ranjan.abhinabera.pyabigbull.R.drawable.ic_action_back));
        ...
        investmentViewPager = (ViewPager) findViewById(nabera.ranjan.abhinabera.pyabigbull.R.id.investmentViewpager);
        setupViewPager(investmentViewPager);

        investmentTabs = (TabLayout) findViewById(nabera.ranjan.abhinabera.pyabigbull.R.id.investmentTabs);
