...
public class TransactionsHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(nabera.ranjan.abhinabera.pyabigbull.R.layout.activity_transactions_history);
        getSupportActionBar().hide();

        transactions = new JsonArray();
        arrayList = new ArrayList<>();

        refreshLayout = (SwipeRefreshLayout) findViewById(nabera.ranjan.abhinabera.pyabigbull.R.id.swipeRefresh);

        historyToolbar = (android.support.v7.widget.Toolbar) findViewById(nabera.ranjan.abhinabera.pyabigbull.R.id.historyToolbar);
        Intent i = getIntent();
        historyToolbar.setTitle(i.getExtras().getString("name"));

        historyToolbar.setNavigationIcon(getResources().getDrawable(nabera.ranjan.abhinabera.pyabigbull.R.drawable.ic_action_back));
        ...
        RecyclerView recyclerView = (RecyclerView) findViewById(nabera.ranjan.abhinabera.pyabigbull.R.id.historyRecycler);
