...
public class ProgressDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedIntsanceState) {
        ...
        final View dialogView = inflater.inflate(nabera.ranjan.abhinabera.pyabigbull.R.layout.progress_dialog_box, null);

        checkLayout = (LinearLayout) dialogView.findViewById(nabera.ranjan.abhinabera.pyabigbull.R.id.layoutsuccess);
        checkView = (CheckView) dialogView.findViewById(nabera.ranjan.abhinabera.pyabigbull.R.id.check);
        TextView messageTv = (TextView) dialogView.findViewById(nabera.ranjan.abhinabera.pyabigbull.R.id.dialog_message);
